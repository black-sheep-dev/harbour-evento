...
Page {
    ...
    SilicaFlickable {
        ...
        Column {
            ...
            Image {
                id: logo
                source: "/usr/share/icons/hicolor/512x512/apps/harbour-evento.png"
                smooth: true
                height: width
            ...
            BackgroundItem{
                ...
                Row{
                    ...
                    Image {
                        ...
                        fillMode: Image.PreserveAspectFit
                        anchors.verticalCenter: parent.verticalCenter
                        source: "/usr/share/harbour-evento/icons/github.svg"
                    }
                    ...
                    Label{
                        ...
                        text: "https://github.com/black-sheep-dev/harbour-evento"
                        color: parent.parent.pressed ? Theme.highlightColor : Theme.primaryColor

                    }
                }
                onClicked: Qt.openUrlExternally("https://github.com/black-sheep-dev/harbour-evento")
            }
